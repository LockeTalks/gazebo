//Set up some recurring variables
var charStr;
var charDex;
var charCon;
var charInt;
...
//Ability score point-buy system
function buyStr() {
	var charPoints = document.getElementById("pointBank").value;
	var charStr = document.getElementById("strBase").value;
	if (charStr>=0 && charStr<=13 && charPoints>=1) {
		document.getElementById("strBase").value++;
...
function buyDex() {
	var charPoints = document.getElementById("pointBank").value;
	var charDex = document.getElementById("dexBase").value;
	if (charDex>=0 && charDex<=13 && charPoints>=1) {
		document.getElementById("dexBase").value++;
		document.getElementById("pointBank").value--;
...
function buyCon() {
	var charPoints = document.getElementById("pointBank").value;
	var charCon = document.getElementById("conBase").value;
	if (charCon>=0 && charCon<=13 && charPoints>=1) {
		document.getElementById("conBase").value++;
		document.getElementById("pointBank").value--;
...
function buyInt() {
	var charPoints = document.getElementById("pointBank").value;
	var charInt = document.getElementById("intBase").value;
	if (charInt>=0 && charInt<=13 && charPoints>=1) {
		document.getElementById("intBase").value++;
		document.getElementById("pointBank").value--;
...
function buyWis() {
	var charPoints = document.getElementById("pointBank").value;
	var charWis = document.getElementById("wisBase").value;
	if (charWis>=0 && charWis<=13 && charPoints>=1) {
		document.getElementById("wisBase").value++;
		document.getElementById("pointBank").value--;
...
function buyCha() {
	var charPoints = document.getElementById("pointBank").value;
	var charCha = document.getElementById("chaBase").value;
	if (charCha>=0 && charCha<=13 && charPoints>=1) {
		document.getElementById("chaBase").value++;
		document.getElementById("pointBank").value--;
...
//Race and class adjustments and factors
function setRaceAdj() {
	
	//Get relevant info from the form
	charRace = document.getElementById("raceSelect").value;
	
	//Reset the feats section so all feats are disabled and un-checked
	// var allFeatCheckboxes = document.getElementsByClassName("featCheckbox");
	//	var i;
	//	for (i = 0; i < allFeatCheckboxes.length; i++) {
	//		document.getElementsByClassName("featCheckbox")[i].checked = false;
	//		document.getElementsByClassName("featCheckbox")[i].disabled = true;
	//	}
	...
	if (charRace == "human") {
		...
		//document.getElementById("featPoints").value = 2;
		...
		//document.getElementById("featPoints").value = 1;
...
function setClass() {
  ...
  class1 = document.getElementById("classSelect").value;
	...
	//Reset the skills section so all skills are un-checked with 0 ranks
	...
	//Set values of various variables dependent on what class has been selected
  ...
  if (class1 == "barbarian") {
    ...
    will = "0";
		...
		document.getElementById("fighterFeatPoints").value = 0;
		document.getElementById("armorProficiencyLight").checked = true;
		document.getElementById("armorProficiencyMedium").checked = true;
		document.getElementById("shieldProficiency").checked = true;
    ...
    will = "2";
		...
		document.getElementById("armorProficiencyLight").checked = true;
		document.getElementById("armorProficiencyMedium").checked = true;
		document.getElementById("armorProficiencyHeavy").checked = true;
		document.getElementById("shieldProficiency").checked = true;
    ...
    will = "0";
		...
		document.getElementById("fighterFeatPoints").value = 1;
		document.getElementById("armorProficiencyLight").checked = true;
		document.getElementById("armorProficiencyMedium").checked = true;
		document.getElementById("armorProficiencyHeavy").checked = true;
		document.getElementById("shieldProficiency").checked = true;
	...
	//Take values determined by class else/ifs and add them to the form
...
function setFeats() {
	...
	//Get relevant info from form
	class1 = document.getElementById("classSelect").value;
	featPoints = document.getElementById("featPoints").value;
	baseAttack = document.getElementById("baseAttack").value;
	charStr = document.getElementById("strFull").value;
	charDex = document.getElementById("dexFull").value;
	charCon = document.getElementById("conFull").value;
	charInt = document.getElementById("intFull").value;
	charWis = document.getElementById("wisFull").value;
	charCha = document.getElementById("chaFull").value;
	//Disable all feats if no points left
	if (featPoints < 1) {
		var allFeatCheckboxes = document.getElementsByClassName("featCheckbox");
			var i;
			for (i = 0; i < allFeatCheckboxes.length; i++) {
		...
		switch (class1) {
			case "barbarian" :
					//First, enable all feats with no prerequisites
					document.getElementById("acrobatic").disabled = false;
					document.getElementById("agile").disabled = false;
					document.getElementById("alertness").disabled = false;
					document.getElementById("animalAffinity").disabled = false;
					document.getElementById("athletic").disabled = false;
					document.getElementById("blindFight").disabled = false;
					document.getElementById("combatCasting").disabled = false;
					document.getElementById("combatReflexes").disabled = false;
					document.getElementById("deceitful").disabled = false;
					document.getElementById("deftHands").disabled = false;
					document.getElementById("diligent").disabled = false;
					document.getElementById("endurance").disabled = false;
					document.getElementById("eschewMaterials").disabled = false;
					document.getElementById("greatFortitude").disabled = false;
					document.getElementById("improvedInitiative").disabled = false;
					document.getElementById("improvedUnarmedStrike").disabled = false;
					document.getElementById("investigator").disabled = false;
					document.getElementById("ironWill").disabled = false;
					document.getElementById("lightningReflexes").disabled = false;
					document.getElementById("magicalAptitude").disabled = false;
					document.getElementById("negotiator").disabled = false;
					document.getElementById("nimbleFingers").disabled = false;
					document.getElementById("persuasive").disabled = false;
					document.getElementById("pointBlankShot").disabled = false;
					document.getElementById("run").disabled = false;
					document.getElementById("selfSufficient").disabled = false;
					document.getElementById("shieldProficiency").disabled = false;
					document.getElementById("skillFocus").disabled = false;
					document.getElementById("stealthy").disabled = false;
					document.getElementById("toughness").disabled = false;
					document.getElementById("track").disabled = false;
					//Next, enable prereq-dependent feats the charcter meets prereqs for
					if (charStr >= 13) {
...
function changeFeatSelection(thisFeat) {
	var featPoints = parseInt(document.getElementById("featPoints").value);
	var isThisFeatChecked = thisFeat.checked;
	if (isThisFeatChecked === true) {
		featPoints--;
	} else if (isThisFeatChecked === false) {
		featPoints++;
	}
	document.getElementById("featPoints").value = featPoints;
}

function resetFeats() {
//Get relevant info from the form
  class1 = document.getElementById("classSelect").value;
	//First, clear the feats section so all feats are disabled and un-checked
	var allFeatCheckboxes = document.getElementsByClassName("featCheckbox");
		var i;
		for (i = 0; i < allFeatCheckboxes.length; i++) {
			document.getElementsByClassName("featCheckbox")[i].checked = false;
	...
	//Then, check some feats based on what class has been selected
  if (class1 == "barbarian") {
		document.getElementById("fighterFeatPoints").value = 0;
		document.getElementById("armorProficiencyLight").checked = true;
		document.getElementById("armorProficiencyMedium").checked = true;
