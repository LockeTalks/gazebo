...
function displayFeats() {
	...
	if (charRace == 'human') {
		...
		document.getElementById("featDisplayZone").innerHTML = feat1;
	}
	if (charClass == 'fighter') {
